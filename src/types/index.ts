...
export type DayBookSourceModule =
  | 'daily_finance'
  | 'weekly_finance'
  | 'monthly_finance'
  | 'loan_disbursement'
...
export interface DayBookEntry {
  ...
  transactionDate: string;
  sourceModule: DayBookSourceModule;
  sourceTransactionId: string;
  transactionType: string;
  customerOrAccountName: string;
  loanOrRefCode?: string;
  description?: string;
  cashIn: number;
  cashOut: number;
  runningBalance: number;
  collectorOrUser: string;
  isReversal?: boolean;
  reversalOfId?: string;
  createdAt?: string;
}
